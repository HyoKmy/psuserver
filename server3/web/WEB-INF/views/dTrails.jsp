...
<div class="topnav">
    <div class="left">
        ...
        <a class="active" href="/server3_war_exploded/dTrails">Trails</a>
...
<div class="add_container">
    ...
    <input type="text" placeholder="Enter Beacon id's" name="beacon_ids" required>
    <input type="text" placeholder="Enter Image id" name="icon_image_id" required>
